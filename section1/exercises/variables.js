...
// log that variable to the console.
var school = "Hogwarts";
console.log(name + ' must not return to ' + school + '!');
...
// How did you decide to use the data type you did for each of the three variables above?
  // The first variable is a string because its asking for a first name
  // The second variable looks like a boolean because its making a statment, yes or no
  // The third variable is asking for a integer.
...
isHungry = 'false'
numberOfPets = 13;
console.log('I think its ' + isHungry + ' that ' + firstName + 'isnt hungry, look at all the shrip hes eating!' + ' He also has like ' + numberOfPets + ' cats.');
