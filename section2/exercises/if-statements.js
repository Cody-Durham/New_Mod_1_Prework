...
if (numQuarters < 2) {
  ...
  console.log('Yep!, you have enough money to buy a gumball')
}


// Old code below is too redundant. 1st attempt so I thought we needed to write multiple
// lines of code.
// if (numQuarters <= 0) {
//   console.log('I dont have enough money for a gumball');
...
if (cupsOfFlour < 2 && hasSauce === true) {
  console.log('I cant make pizza.');
} else if (cupsOfFlour >= 2 && hasSauce === true) {
  console.log('I can made a da pizza!! Yippie!')
}
...
//   console.log("I cant make any pizza")
// } else if (cupsOfFlour == 1 && hasSauce == false) {
//   console.log("I cant make any pizza")
// } else if (cupsOfFlour == 2 && hasSauce == true) {
//   console.log("I can make a da pizza!")
